  ...
  return (
    <div>
      ...
      <div className="flex flex-col p-6 text-center items-center sm:flex-row sm:text-start">
        ...
        />
        <div className="sm:ml-5">
          <h1 className="text-lg font-bold mt-4">Agenda de Tarefas</h1>
          <p>
            Um projeto FullStack que está em andamento. Nele pode colocar as
            suas tarefas e marcar como feito ou pendente. Assim que estiver
            concluído estará aqui.
          </p>
        </div>
      </div>
      <div className="flex flex-col items-center text-center sm:flex-row-reverse sm:text-right">
        ...
        />
        <div className="sm:mr-5">
          <h1 className="text-lg font-bold mt-4 sm:mt-0">Projeto Integrador</h1>
          <p>
            Um projeto FullStack que está em andamento. Ele será usado para o
            conclusão do curso. Com a formção do curso o projeto estará
            disponível aqui.
          </p>
        </div>
      </div>
